...
<head>
    ...
    <style>
        ...
        .lds-ring {
            ...
            position: relative;
            width: 16px;
            /* Adjust the width to match the size of the <i> element */
            height: 16px;
            /* Adjust the height to match the size of the <i> element */
        }
        ...
        .lds-ring div {
            ...
            /* Adjust the height to match the size of the <i> element */
            margin: 1.6px;
            /* Adjust the margin to match the size of the <i> element */
            border: 1.6px solid #fff;
            /* Adjust the border size to match the size of the <i> element */
            border-radius: 50%;
    ...
    <div id="page-container" class="sidebar-o   enable-page-overlay side-scroll page-header-fixed main-content-narrow">
      ...
      -->
                    ...
                    <div class="dropdown d-inline-block ms-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0 fs-sm"
                            ...
                            <div class="p-2 bg-body-light border-bottom text-center rounded-top">
                                <h5 class="dropdown-header text-uppercase">Notifikasi Pesan </h5>
                            </div>
                                        ...
                                        @foreach ($notif as $key)
                                            <a class="text-dark d-flex py-2"
                                                ...
                                                <div class="flex-grow-1 pe-2">
                                                    <div class="fw-semibold">Kamu menerima pesan baru dari
                                        ...
                                        @if (isset(Auth::user()->notif))
                                            @foreach (Auth::user()->notif as $key)
                                                <a class="text-dark d-flex py-2"
                                                    ...
                                                    <div class="flex-grow-1 pe-2">
                                                        <div class="fw-semibold">Kamu menerima pesan baru dari admin
                                                            pakar</div>
                                                        <span
                                                            class="fw-medium text-muted">{{ $key->created_at->diffForHumans() }}</span>
                                                    </div>
        ...
        <script>
            ...
            // Fungsi untuk melakukan scroll ke bagian bawah
            function scrollToBottom() {
                div.scrollTop = div.scrollHeight;
            }

            // Panggil fungsi scrollToBottom() saat konten dalam div berubah
            div.addEventListener('DOMSubtreeModified', scrollToBottom);

            // Panggil fungsi scrollToBottom() untuk melakukan scroll ke bagian bawah saat halaman dimuat
            scrollToBottom();
        </script>
