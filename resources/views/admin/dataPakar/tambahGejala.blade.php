                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-12 overflow-hidden">
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="file" name="gambarGejala" id="gambarGejala" multiple>
                                @error('gambarGejala')
                        ...
                        <div class="col-lg-8 col-xl-12 overflow-hidden">
                            <div class="mb-4">
                                <label class="form-label" for="example-file-input-multiple">Pilih Foto</label>
                                <input class="form-control" type="file" name="gambarGejala2" id="gambarGejala2" multiple>
                                @error('gambarGejala2')
                                    <span class="text-danger" style="font-size: 0.875rem;">
                        ...
                        <div class="col-lg-8 col-xl-12 overflow-hidden">
                            <div class="mb-4">
                                <label class="form-label" for="example-file-input-multiple">Pilih Foto</label>
                                <input class="form-control" type="file" name="gambarGejala3" id="gambarGejala3" multiple>
                                @error('gambarGejala3')
                                    <span class="text-danger" style="font-size: 0.875rem;">
