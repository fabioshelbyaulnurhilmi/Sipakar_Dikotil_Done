                ...
                <tbody>
                    ...
                    @foreach ($chat->unique('sender_id') as $key)
                        <tr>
                            ...
                            <td class="fw-normal fs-sm" style="text-align: justify">
                                @if ($key->isi)
                                    {{ $key->isi }}
                                @else
                                    <img class="img-thumbnail mx-auto d-block  " style="max-height: 100px;"
                                        src="{{ asset('storage/' . str_replace('public/', '', $key->gambar)) }}"
                                        alt="" srcset="">
                                @endif
                            </td>
