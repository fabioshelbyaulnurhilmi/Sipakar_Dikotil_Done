                ...
                <div class="row push">
                    <div class="col-lg-8 col-xl-5">
                        <div class="mb-1">
                            ...
                            <div id="star-rating" class="js-rating" data-star-on="fa fa-fw fa-star text-info"
                                data-star-off="fa fa-fw fa-thumbs-up text-muted" data-target=".js-rating-hint-text"></div>
