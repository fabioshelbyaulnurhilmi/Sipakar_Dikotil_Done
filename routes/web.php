...
route::get('/cetak/{id}',[LaporanController::class,'cetak_coba'])->middleware('auth')->name('cetak-detail');
...
Route::get('/editProfile/{id}', [dataAdminController::class,'editProfile'])->middleware('auth')->name('edit-profile');
Route::post('/updateProfile', [dataAdminController::class,'updateProfile'])->middleware('auth')->name('update-profile');
